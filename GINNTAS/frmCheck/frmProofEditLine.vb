...
Public Class frmProofEditLine
    ...
    Private Sub b_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_Save.Click
        ...
        For i = 0 To DataGridView_LineBatch.Rows.Count - 1
            If DataGridView_LineBatch.Item(16, i).Value = "Y" Then
                OverrideLoadMeter(CLng(txtBatchNo.Text.Trim), DataGridView_LineBatch.Item(1, i).Value, DataGridView_LineBatch.Item(6, i).Value, DataGridView_LineBatch.Item(7, i).Value, _
                                  IIf(DataGridView_LineBatch.Item(8, i).Value = "", 0, CDbl(DataGridView_LineBatch.Item(8, i).Value)), CDbl(DataGridView_LineBatch.Item(9, i).Value), CDbl(DataGridView_LineBatch.Item(4, i).Value), CDbl(DataGridView_LineBatch.Item(5, i).Value), _
                                  CDbl(DataGridView_LineBatch.Item(12, i).Value), CDbl(DataGridView_LineBatch.Item(13, i).Value), DataGridView_LineBatch.Item(15, i).Value, DataGridView_LineBatch.Item(10, i).Value, CLng(DataGridView_LineBatch.Item(11, i).Value), _
