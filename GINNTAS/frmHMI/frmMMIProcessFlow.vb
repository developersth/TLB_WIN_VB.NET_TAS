...
Public Class frmMMIProcessFlow
    ...
    Private Sub frmLoadDO_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs)
        'UcStatus1.StopThread()
        CloseForm(FormScreenID, "")
    End Sub
    Private Sub frmMMIProcessFlow_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        vPage = 1
        indexMeter = 0
    ...
    Private Sub InitailFlowMeter()
        ...
        For i = 1 To MeterCount
            If i <> 0 Then
                ...
                Me.Controls.Add(UcFlowLoading(i))
                ...
                Select Case i
                    Case 1, 5, 9, 13, 17, 21
                        ...
                        UcFlowLoading(i).location = New Point(UcFlowLoading1.Location.X, UcFlowLoading1.Location.Y)
                    Case Else
                        ...
                        UcFlowLoading(i).location = New Point(UcFlowLoading(i - 1).Location.X, UcFlowLoading(i - 1).Location.Y + +UcFlowLoading1.Size.Height)
                End Select
            End If
...
#Region "thread"
    ...
    Private Sub RunProcess()
        While (1)
            Try
                SyncLock (UcFlowLoading1.tThrLock)
