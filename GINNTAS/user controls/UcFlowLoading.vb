...
Public Class UcFlowLoading
    ...
    Public Sub GetDetailFlowLineMeter(ByVal Index As Integer)
        ...
        strSQL = _
                  " select " & _
                  " t.METER_NO , t.BASE_PRODUCT_ID, t.Sale_Product_Id,t.CONNECT_STATUS, t.BATCHING_ACTIVE, t.FLOW_RATE " & _
                  " ,t.TEMPERATURE,t.PRESSURE,t.LOAD_HEADER_NO,t.BATCH_NO,t.TU_CARD_NO,t.VEHICLE_NUMBER,t.VEHICLE,t.driver_name ,t.Compartment_No " & _
                  " ,t.TANK_ID,t.TANK_NAME,t.ADVICE,t.DENSITY_15C,t.LOADED_GROSS,t.PERCENT_LOADED ,t.compament_capacity" & _
                  " ,t.BATCH_STATUS_NUM,t.BATCH_STATUS,t.PLC_CONNECT_STATUS,t.PUMP_SEL_SPARE,t.PUMP_NAME" & _
                  " ,t.PUMP_MODE,t.PUMP_RUN,t.TEMP_NAME,t.PRESSURE_NAME,t.FV_NAME,t.ARM_SIDE_A,t.ARM_SIDE_B ,t.ARM_LEFT_ACTIVE,t.ARM_RIGHT_ACTIVE" & _
    ...
    Private Sub InitailProgressTank(ByVal iTank As String)
        ...
        strSQL = _
                        " select " & _
                        " t.base_product , t.tank_high,t.tank_capacity " & _
                        " ,t.level_l , t.level_h , t.level_ll , t.level_hh ,t.levels " & _
                        " from tas.view_map_tank_data t " & _
                        " where t.tank_name = '" & Trim(iTank) & "' " & _
                        " order by t.tank_id "
    ...
    Private Sub GetMeterValue(ByVal iMeter As String)
        ...
        strSQL = _
                      "select  * " & _
                      " from tas.view_mmi_bay_meter a" & _
                      " Where A.METER_NO ='" & iMeter & "' " & _
                      " Order by A.METER_NO "
