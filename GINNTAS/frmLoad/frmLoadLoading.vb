...
Public Class frmLoadLoading
    ...
    Private Sub UcMenu_edit_Excise_Name_OnClickMnuText(ByVal ucName As System.String, ByVal ucScreenID As System.Int64)
        Dim strLoadNo As String
        If MSGridHeader.Rows.Count <= 0 Then Exit Sub
        With MSGridHeader
            strLoadNo = .Item(1, .CurrentRow.Index).Value
        End With
        frmLoadEditExcise.Close()
        frmLoadEditExcise.InitialLoadNo(strLoadNo)
        frmLoadEditExcise.ShowDialog()
