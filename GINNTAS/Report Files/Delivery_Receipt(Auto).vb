...
Public Class Delivery_ReceiptAuto
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Delivery_Receipt(Auto).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GINNTAS.Delivery_Receipt(Auto).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_iLoadHeaderNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedDelivery_ReceiptAuto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Delivery_ReceiptAuto = New Delivery_ReceiptAuto()
        rpt.Site = Me.Site
        Return rpt
    End Function
