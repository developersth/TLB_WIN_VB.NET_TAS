...
#End Region
    ...
    Private Sub AssignValue()
        ...
        Dim i As Integer
        sql_str = _
        "select R.REPORT_ID,R.REPORT_NAME,R.HEADER_ID,R.REPORT_PATH,R.PRINTER_ID,H.HEADER_NAME,P.PRINTER_NAME," & _
        ...
        If Oradb.OpenDys(sql_str, "TableName1", mDataSet) Then
            ...
            txtReportName.Text = IIf(IsDBNull(dt.Rows(i).Item("REPORT_NAME")), "", dt.Rows(i).Item("REPORT_NAME").ToString)
