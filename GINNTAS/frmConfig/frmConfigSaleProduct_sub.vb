...
#End Region
    ...
    Private Sub Save()
        ...
        "AUTO_SORT,IS_ENABLE,GROUP_NAME) " & _
        "values(" & _
        ...
        IIf(OptEnabled.Checked = True, 1, 0) & ",'" & Trim(txtGroupPro.Text) & "')"
    ...
    Private Sub AssignValue()
        ...
        "S.AUTO_SORT,S.IS_ENABLE,s.base_product_id,s.is_meter_load,s.IS_CHECK_TARE_WIEGHT " & _
