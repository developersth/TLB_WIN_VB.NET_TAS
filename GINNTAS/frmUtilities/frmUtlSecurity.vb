...
Public Class frmUtlSecurity
    ...
    Public Sub Show_Data(ByVal PriorityID As Long)
        ...
        sql_str = _
              "select S.SCREEN_ID,S.SUB_ID,S.MAIN_MENU,S.SUB_MENU " & _
            "from TAS.SCREEN S " & _
            "order by S.SCREEN_ID,S.SUB_ID"
        sql_str2 = _
           "select S.SCREEN_ID,S.SUB_ID,S.MAIN_MENU,S.SUB_MENU,C.PERMISSION,C.CONFIRM_PASSWORD " & _
...
#End Region
    ...
    Private Sub PrintReport(ByVal pGroup As Long)
        ...
        Dim strSql As String
        strSql = "select * " & _
                          "from tas.view_user_security_permission " & _
